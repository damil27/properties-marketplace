  ...
  const onSubmit = async (e) => {
    ...
    if (geolocationEnabled) {
      const response = await fetch(
        `https://maps.googleapis.com/maps/api/geocode/json?address=${address}&key=AIzaSyD5gYDMmiwdO2uwX1g6jPlrmrkOj_k0vmc`
      );
      ...
      if (location === undefined || location.includes("undefined")) {
        setLoading(false);
        toast.error("Can not locate your location from map");
      }
    } else {
